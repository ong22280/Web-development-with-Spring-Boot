...
//        model.addAttribute("menus", menuService.getAllMenus()); // ส่งข้อมูล menus ทั้งหมดไปแสดงผลที่หน้า menu-all.html
...
//        model.addAttribute("menus", menuService.getAllMenus());
        model.addAttribute("categories", categoryService.getAllCategories());
        return "redirect:/menus"; // ใส่ redirect: เพื่อให้เปลี่ยน url ให้เป็น /menus หลังจากบันทึกสำเร็จ
    }
}
